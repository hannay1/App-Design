...
1. exeptions (try/catch)
2. return null/empty array/etc
3.call error function (request.on ("error") etc)
*/
}
...
{
 console.log("if try could not sort out the given file & url parameters that aren't supposed to work,");
 console.log("then this error message will show up");
